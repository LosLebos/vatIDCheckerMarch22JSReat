    ...
    create: function (context) {
        ...
        function findLoadBeforeSync() {
            ...
            apiReferences.forEach((apiReference) => {
                ...
                if (operation === "Load" &&
                    variable &&
                    ((_a = identifier.parent) === null || _a === void 0 ? void 0 : _a.type) == experimental_utils_1.TSESTree.AST_NODE_TYPES.MemberExpression) {
                    const propertyNames = (0, load_1.parseLoadArguments)(identifier.parent);
                ...
                if (operation === "Read" && variable) {
                    const propertyName = (0, utils_1.findPropertiesRead)(reference.identifier.parent);
        ...
        return {
            Program() {
                apiReferences = (0, utils_1.findOfficeApiReferences)(context.getScope());
