...
function isGetFunction(node) {
    return (node.type == experimental_utils_1.TSESTree.AST_NODE_TYPES.CallExpression &&
        node.callee.type === experimental_utils_1.TSESTree.AST_NODE_TYPES.MemberExpression &&
        node.callee.property.type === experimental_utils_1.TSESTree.AST_NODE_TYPES.Identifier &&
