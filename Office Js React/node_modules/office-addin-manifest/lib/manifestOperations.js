            ...
            if (manifestPath) {
                if (guid === undefined && displayName === undefined) {
                    ...
                    try {
                        ...
                        manifestData = yield manifestHandler.modifyManifest(guid, displayName);
...
function getManifestHandler(manifestPath) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (manifestPath.endsWith(".json")) {
            manifestHandler = new manifestHandlerJson_1.ManifestHandlerJson();
        }
        else if (manifestPath.endsWith(".xml")) {
            manifestHandler = new manifestHandlerXml_1.ManifestHandlerXml();
        }
        else {
        ...
        yield manifestHandler.readFromManifestFile(manifestPath);
